...
function VeloraCityX:CreateWindow(config)
	...
	function Window:AddTab(tabConfig)
		...
		local TabIconLabel = Instance.new("TextLabel", TabInner)
		...
		function Tab:AddSlider(sliderConfig)
			...
			-- Box biru lebar di sisi kanan, mirip ArrayField
			...
			-- Track container di kanan value label
