...
function NeizHubUiLibrary:CreateWindow(config)
	...
	function Window:AddTab(tabConfig)
		...
		local function activateTab()
			...
			TweenService:Create(TabIconLabel, TweenInfo.new(0.2), {TextColor3 = RED}):Play()
		...
		function Tab:AddSlider(sliderConfig)
			...
			sliderBox.BackgroundColor3 = Color3.fromRGB(140, 30, 30)
			...
			trackBg.BackgroundColor3 = Color3.fromRGB(50, 15, 15)
			...
			trackFill.BackgroundColor3 = RED
		...
		function Tab:AddDropdown(dropConfig)
			...
			for idx, opt in ipairs(options) do
				...
				optBtn.MouseEnter:Connect(function()
					TweenService:Create(optBtn, TweenInfo.new(0.1), {BackgroundTransparency = 0.1, TextColor3 = RED}):Play()
				end)
