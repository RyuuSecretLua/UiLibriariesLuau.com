...
function VeloraCityX:CreateWindow(config)
	...
	function Window:AddTab(tabConfig)
		...
		local iconAsset = tabIcon ~= "" and Icons.GetIcon(tabIcon) or nil
		local TabIconLabel
		...
		if iconAsset then
			...
			TabIconLabel.Image = type(iconAsset) == "table" and iconAsset[1] or iconAsset
			if type(iconAsset) == "table" and iconAsset[2] then
				TabIconLabel.ImageRectSize = iconAsset[2].ImageRectSize
				TabIconLabel.ImageRectOffset = iconAsset[2].ImageRectPosition
			end
		...
		function Tab:AddSlider(sliderConfig)
			...
			sliderBg.Size = UDim2.new(0, 160, 0, 28)
			sliderBg.AnchorPoint = Vector2.new(1, 0.5)
			sliderBg.Position = UDim2.new(1, -10, 0.5, 0)
			sliderBg.BackgroundColor3 = Color3.fromRGB(18, 10, 30)
			...
			local numLabel = Instance.new("TextLabel", sliderBg)
			numLabel.Size = UDim2.new(0, 36, 1, 0)
			numLabel.Position = UDim2.new(0, 6, 0, 0)
			numLabel.BackgroundTransparency = 1
			numLabel.Text = tostring(value)
			numLabel.TextColor3 = PURPLE
			...
			trackBg.Size = UDim2.new(1, -50, 0, 4)
			trackBg.Position = UDim2.new(0, 44, 0.5, -2)
			trackBg.BackgroundColor3 = Color3.fromRGB(50, 35, 70)
			...
			trackFill.BackgroundColor3 = PURPLE
